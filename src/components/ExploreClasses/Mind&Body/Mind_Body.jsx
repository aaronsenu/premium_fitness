...
const Strength = () => {
  return (
    ...
    <div className='mind_body-page' id = "MindBody">
        <div className='blur mind_body-blur'></div>
            <div className='mind_body-hero' >
            ...
            {/* Hero Heading */}
            <div className='mind_body-text'>
                <div>
                    <span>CLASS CATEGORIES</span>
                </div>

                <div>
                    <span  className = "stroke-text">MIND & <br/></span>
                    <span>BODY</span>
            ...
            {/* Buttons */}
            <div className="mind_body_hero-button">
            ...
            {/* banner */}
            <img src={hero} alt="" className='mind_body_banner'/>
            <img src={banner_circle1} alt="" className='mind_body_banner-circle1'/> {/* Luminosity effect */}
            <img src={banner_circle2} alt="" className='mind_body_banner-circle2'/>
        ...
        <div className='mind_body-categories_page'>
            ...
            <div className='mb-intensity-header'>
                <div>
            ...
            <div className='mind_body-classes'>
                <IntensityFilters/>

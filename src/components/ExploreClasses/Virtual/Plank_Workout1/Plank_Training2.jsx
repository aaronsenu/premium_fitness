    ...
    const renderTime = ({ remainingTime }) => {
      ...
      const renderTime2 = ({ remainingTime }) => {
        if (remainingTime === 0) {
         ...
         else if (remainingTime <= 40 && remainingTime>10){
          return(
          <div className="workout_timer1">
         ...
         else if (remainingTime <= 60 && remainingTime>20){
          return(
          <div className="workout_timer1">
         ...
         else if (remainingTime <= 120 && remainingTime>30){
          return(
          <div className="workout_timer1">
         ...
         else if (remainingTime <= 160 && remainingTime>40){
          return(
